...
\emph{NEST} \citep{nest} \todo{please cite the original Scholarpedia and the latest release here} is a simulator for large-scale networks of spiking and non-spiking neural networks used in computational neuroscience to build models of brain-like or brain-inspired neuronal circuits. It profits from the efficiency of C++ to simulate networks with large numbers of neurons and synaptic connections and is parallelized using MPI and OpenMP. By providing a Python interface \citep[\emph{PyNEST};][]{10.3389/neuro.11.012.2008} \todo{also add https://doi.org/10.3389/fninf.2014.00023 here} that interacts with the \emph{NestKernel} in C++, users can easily define their simulations and add new models dynamically at the runtime by means of the function \texttt{nest.Install()}.
